...
const PaswordRestore = () => {
  ...
  return (
    <div className={styles.mainDiv}>
        ...
        <p>Enter your email so that we can send you an email to create a new password.</p>
        <div className={styles.inputContainer}>
        <input className={styles.input} placeholder='Your email...' type='email' value={email} onChange={handleEmail}/>
